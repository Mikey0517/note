...
exports.getResourceName = function ( DEV_MODE ) {
	return exports.getName( '[name]', '[ext]', 'hash', DEV_MODE );
};
		...
		use: [
			{
				...
				options: {
					context,
					name: path.join( 'image', exports.getResourceName( devMode ) ),
					limit: 4096,
				},
			},
			// {
...
exports.getMediaLoader = function ( devMode, context ) {
	return {
		...
		options: {
			context,
			name: path.posix.join( 'media', exports.getResourceName( devMode ) ),
			limit: 5000,
		},
	};
};
